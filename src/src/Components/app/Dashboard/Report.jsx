...
const Report = () => {
  ...
  return (
    <div className=" text-dark shadow-md  bg-gray-900  border-gray-300 rounded-4 p-2">
      <div className="d-flex justify-content-between align-items-center text-light">
        ...
        <div>
          <FormControl className=" rounded-2 " style={{ width: "80px" }}>
      ...
      <div className="row my-3">
        <div className="col-md-6">
          <div className="bg-sky-700 border rounded-2 p-4 text-light">
        ...
        <div className="col-md-6">
          <div className=" border rounded-2 p-4 text-light">
        ...
        <div className="col-md-6 mt-3">
          <div className="custom_red_color text-light rounded-2 px-2 py-3">
